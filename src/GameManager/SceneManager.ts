class GameScene extends engine.DisplayObjectContainer implements EventEmitter {
    ...
    private i = 2;
    private onEnterFrame = (event: engine.MyTouchEvent) => {
        //console.log('hi');
        ...
        console.log("width" + this.user.role._role.width + "height" + this.user.role._role.height);
        console.log("role.x" + this.user.role.x + "role.y" + this.user.role.y);
        console.log("role.x" + this.user.role.x + "role.y" + this.user.role.y);
    }
...
class SecneManager extends engine.DisplayObjectContainer {
